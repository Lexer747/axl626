...
\begin{titlingpage}
    ...
    {\Huge\bfseries Portfolio Optimization Using Geometric Mean, Risk Correlation 
        \& Multi-Variable Genetic Algorithms\par}
        \vspace{2.5cm}
...
\section{What is Portfolio Optimization?}
    ...
    Alot of work is already based on this simple premise of min-maxing risk and
    ...
    of portfolio's in an abstract way. This was developed futher into more specific
    ...
    correlation. Applying them to the rich data set provided
    by my supervisor, and formulating an experiment to test whether using
    multi-variable genetic algorithms (GAs explained in \ref{section:GA}) come to
    good solutions.

\subsection{Kelly Criterion \& Assumptions}

    Kelly Criterion \cite{Kelly} as concept is a great theoretical achievement, such a simple formula so
    ...
    real world. Aswell as dealing with more than one stock.
...
\subsection{Decoupling \(G\)}
    ...
    and futhermore it is the basis of my work for equation \ref{eq:DecoupleR}, aswell as
    the aggregator for equation \ref{eq:DecoupleG}.
...
\section{Solving \(f\) with respect to \(G\)}
    ...
    we gain facortially many more combinations to check.
    ...
    time of our evaluation functions. It becomes completely impossibile to actually calculate
...
\subsection{Genetic Algorithms}\label{section:GA}
    ...
    principle of \textit{surivial of the fittest}.
